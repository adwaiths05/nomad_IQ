...
if _pydantic_settings is not None:
    ...
    class Settings(_settings_module.BaseSettings):
        ...
        # Land-based transport MCP tools for India (trains, buses, metro, walking)
        mcp_tool_travel_search_trains: str = "search_trains"
        mcp_tool_travel_search_buses: str = "search_buses"
        mcp_tool_travel_search_metro: str = "search_metro"
        ...
        # India-only transport APIs
        indian_railways_api_key: str | None = None
        ...
        model_config = _settings_module.SettingsConfigDict(env_file=str(ENV_FILE), extra="ignore")
